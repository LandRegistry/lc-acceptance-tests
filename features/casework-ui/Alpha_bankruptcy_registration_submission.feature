...
Feature: Validate and Submit forms

As a land charges caserworker
I want to be able to submit data entered on a bankruptsy application forms
So that I can ensure that valid details are captured onto the land charges register
