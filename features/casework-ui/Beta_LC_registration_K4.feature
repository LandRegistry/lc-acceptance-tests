...
Scenario: BUS-099 BUS-130 Verify mandatory two stage name re-entry when completing a Land Charges registration application
  ...
  When I have selected to view a K four Land Charges application from the application list
  When I access the application screen for a K4 the class type is set to WO
