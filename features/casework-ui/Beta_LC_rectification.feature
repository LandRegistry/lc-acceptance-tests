...
Scenario: BUS-095 Reclassify a form from K9 to a PAB
Given I count number of forms available on Land Charge rectification screen
When I can reclassify the form to a PAB Registration type
